...
function ProductActions() {
    ...
    // Step 2: Add State for Snackbar Visibility and Error Message
    ...
    const getProductById = () => {
        ...
        fetch(`http://localhost:8080/products/${id}`) // Corrected URL with http://
            ...
            let resolutionMessage = 'No resolution available'; // Default resolution
            if (typeof error === 'object') {
                message = error.errormessage || message; // Note the lowercase 'm' in errormessage
                resolutionMessage = error.resolution || resolutionMessage;
    ...
    return (
        <div style={{...containerStyle, flexDirection: 'column'}}> {/* Ensure the container uses column layout */}
            ...
            <Snackbar open={snackbarOpen} autoHideDuration={6000} onClose={handleSnackbarClose}>
                <MuiAlert onClose={handleSnackbarClose} severity="error" elevation={6} variant="filled" style={{ whiteSpace: 'pre-line' }}>
